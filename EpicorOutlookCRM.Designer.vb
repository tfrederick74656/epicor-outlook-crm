...
Partial Public NotInheritable Class EpicorOutlookCRM
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _EpicorOutlookCRM As EpicorOutlookCRM
    ...
    Friend Shared Property EpicorOutlookCRM() As EpicorOutlookCRM
        Get
            Return _EpicorOutlookCRM
        End Get
        Set
            If (_EpicorOutlookCRM Is Nothing) Then
                _EpicorOutlookCRM = value
            Else
    ...
    Friend Shared ReadOnly Property FormRegions() As ThisFormRegionCollection
        Get
            If (_ThisFormRegionCollection Is Nothing) Then
                _ThisFormRegionCollection = New ThisFormRegionCollection(Globals.EpicorOutlookCRM.GetFormRegions)
            End If
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal explorer As Microsoft.Office.Interop.Outlook.Explorer) As WindowFormRegionCollection
        Get
            Return CType(Globals.EpicorOutlookCRM.GetFormRegions(explorer, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal inspector As Microsoft.Office.Interop.Outlook.Inspector) As WindowFormRegionCollection
        Get
            Return CType(Globals.EpicorOutlookCRM.GetFormRegions(inspector, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
End Class
